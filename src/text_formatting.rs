...
pub const FUTURAMA_PROPER_NOUNS: &[&str] = &[
    "fry", "leela", "bender", "professor", "farnsworth", "zoidberg", "amy", "hermes", 
    "zapp", "brannigan", "kif", "nibbler", "mom", "robot", "hypnotoad", "scruffy", 
    "nixon", "calculon", "lrrr", "morbo", "linda", "url", "roberto", "flexo", "cubert",
    "dwight", "labarbara", "wernstrom", "bubblegum", "tate", "planet", "express", 
    "omicron", "persei", "earth", "mars", "neptune", "uranus", "mercury", "venus", 
    "jupiter", "saturn", "pluto", "new", "york", "new", "jersey", "robot", "devil", 
    "hedonismbot", "slurms", "mckenzie", "destructor", "crushinator", "donbot", 
    "clamps", "joey", "mousepad", "elzar", "ndnd", "yivo", "america", "american", 
    "usa", "u.s.a.", "u.s.", "god", "jesus", "christmas", "thanksgiving", "halloween",
...
pub const RICK_AND_MORTY_PROPER_NOUNS: &[&str] = &[
    "rick", "morty", "summer", "beth", "jerry", "smith", "sanchez", "unity", "birdperson",
    "squanchy", "meeseeks", "gazorpazorp", "gearhead", "tammy", "evil", "morty", "jessica",
    "snuffles", "snowball", "mr.", "meeseeks", "abradolf", "lincler", "scary", "terry",
    "krombopulos", "michael", "mr.", "poopybutthole", "noob", "noob", "pencilvester",
    "america", "american", "usa", "u.s.a.", "u.s.", "god", "jesus", "christmas", 
    "thanksgiving", "halloween", "monday", "tuesday", "wednesday", "thursday", "friday", 
    "saturday", "sunday", "january", "february", "march", "april", "may", "june", "july", 
    "august", "september", "october", "november", "december", "earth", "c-137", "citadel",
    "federation", "galactic", "federation", "council", "ricks", "dimension", "portal", "gun"
];
